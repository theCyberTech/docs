---
title: 'Overview'
description: 'Overview of crewAI'
---

## Setup your development

CrewAI is a framework for building and evaluating multi-agent systems. It is designed to be easy to use and understand, with a focus on providing a simple and flexible interface for building and evaluating multi-agent systems.
